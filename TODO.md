...
- [ ] 人工审读 `dist/pic-tutor-v0.10.html`，重点检查第 7 章 regression 索引表和 v0.10 新增正文在 HTML 中的宽度、换行、公式和链接可读性。
...
- [ ] 为 v0.11 继续细核 `GuardCellManager.cpp`、`WarpXComm.cpp`、`WarpXRegrid.cpp`，把 AMR/regrid/guard-cell 从入口地图扩成第 7 章正文。
