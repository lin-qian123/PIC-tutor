...
- [ ] 人工审读 `dist/pic-tutor-v0.9.html`，重点检查第 7 章 regression 索引表在 HTML 中的宽度、换行和链接可读性。
...
- [ ] 为 v0.10 选择 3-4 条强 analysis 路径扩写成正文：建议从 particle boundaries、PEC/PMC、particles-in-PML 和 RZ scraping 开始。
