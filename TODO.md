...
- [ ] 为 v0.25 继续完成 LeeCPC2015 全文闭环：通过机构访问、OSTI 可用全文、eScholarship 可访问副本或 AIP 可访问 PDF 取得授权 PDF，执行 MinerU 转换，补逐段中文讲解和图片，并把 pseudo-spectral PML 反射率/效率公式与 WarpX 当前 `PsatdAlgorithmPml.cpp` 做逐项对应。
