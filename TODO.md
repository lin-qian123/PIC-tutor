...
- [ ] 为 v0.19 继续推进第 6 章 NCI 策略谱系：选择 Godfrey PSATD/NCI 论文，补 MinerU Markdown、图片、中文讲解笔记，并把 filtering、`E/B` correction、current scaling 与 Galilean 表示的差异接回 WarpX 参数和 regression。
