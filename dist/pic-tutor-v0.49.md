...
当前合订 PDF 为 309 页；本 v0.49 版本在 v0.48 基础上补入 3D AMR particles-in-PML 的 signed/absolute/level decomposition，明确官方 signed gate、严格 absolute gate 和负向 PML 峰值之间的证据边界。
