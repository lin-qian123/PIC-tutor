...
6. Phase 4 closure: three-theme builds, reproducible double build, new edition identifier + release manifest, docs updates, migration report, page-level visual review.
