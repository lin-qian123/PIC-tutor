...
从 `dist/pic-tutor-v0.101.pdf` 渲染第 1、184、191、192、193、287、330 页为 PNG，并用本地图像查看器检查页边界、长 inline code、标题层级、列表、表格和页码。第 184 页是 rho-side family 说明页，第 191-193 页覆盖 formal convergence、repeat stability、源码-诊断交叉审计和本版 axis divergence stencil 段落，第 287 页覆盖 transition-zone runtime activation 段落，第 330 页是第 9 章当前缺口登记页。

## 结果

| 页码 | 检查内容 | 结果 |
|---:|---|:---:|
| 1 | v0.101 标题、目录点线、章节页码和左右边界 | PASS；未见重叠、截断或越界 |
