...
| `dist/pic-tutor-v0.68.pdf` | 3,407,734 bytes | 当前 323 页成书候选，可单独审计后发布 |
| `dist/pic-tutor-v0.68.html` | 5,779,420 bytes | 自包含 MathJax + 16 张图片，可作为预览候选 |
| `dist/pic-tutor-v0.68.md` | 1,101,696 bytes | 当前合订源，可作为文本 release 候选 |
