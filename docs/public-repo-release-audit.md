...
| `dist/pic-tutor-v0.110.pdf` | 3,002,132 bytes / 264 页 | 当前成书候选，可单独审计后发布 |
| `dist/pic-tutor-v0.110.html` | 5,254,806 bytes | 自包含 MathJax + 15 张图片，可作为预览候选 |
| `dist/pic-tutor-v0.110.md` | 862,895 bytes | 当前合订源，可作为文本 release 候选 |
