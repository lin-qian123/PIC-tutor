...
| `dist/pic-tutor-v0.110.pdf` | 2,998,120 bytes / 270 页 | 当前成书候选，可单独审计后发布 |
| `dist/pic-tutor-v0.110.html` | 5,270,019 bytes | 自包含 MathJax + 15 张图片，可作为预览候选 |
| `dist/pic-tutor-v0.110.md` | 869,173 bytes | 当前合订源，可作为文本 release 候选 |
