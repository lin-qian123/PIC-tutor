...
| `dist/pic-tutor-v0.68.pdf` | 3,363,953 bytes | 当前 316 页成书候选，可单独审计后发布 |
| `dist/pic-tutor-v0.68.html` | 5,738,320 bytes | 自包含 MathJax + 16 张图片，可作为预览候选 |
| `dist/pic-tutor-v0.68.md` | 1,066,779 bytes | 当前合订源，可作为文本 release 候选 |
