...
| `dist/pic-tutor-v0.110.pdf` | 2,997,132 bytes / 263 页 | 当前成书候选，可单独审计后发布 |
| `dist/pic-tutor-v0.110.html` | 5,247,448 bytes | 自包含 MathJax + 15 张图片，可作为预览候选 |
| `dist/pic-tutor-v0.110.md` | 859,624 bytes | 当前合订源，可作为文本 release 候选 |
