...
- scope: entry-point and learning-path audit; versioned evidence headings have been separated from core tutorial chapters; a 262-page baseline has a complete recorded manual read and the current 272-page candidate has recorded Chapter 1, Chapter 2, Chapter 3, Chapter 3A, Chapter 4, Chapter 5, Chapter 6, Chapter 7, Chapter 8, and Chapter 9 incremental reviews
...
| `chapter_9_reader_navigation` | `PASS` |
| `chapter_9_evidence_routes_reader_card` | `PASS` |
...
| `chapter_5_vay_configuration_reader_card` | `PASS` |
| `chapter_5_rz_implicit_villasenor_reader_card` | `PASS` |
| `chapter_5_deposition_validation_ladder_reader_card` | `PASS` |
| `chapter_4_5_multiphysics_source_handoff` | `PASS` |
| `chapter_6_opening_is_reader_facing` | `PASS` |
| `chapter_6_current_solver_route` | `PASS` |
| `chapter_6_field_solver_validation_ladder_reader_card` | `PASS` |
| `chapter_5_6_source_to_field_handoff` | `PASS` |
...
| `chapter_7_load_balance_validation_reader_card` | `PASS` |
...
| `chapter_1_thermal_plasma_resolution_reader_card` | `PASS` |
