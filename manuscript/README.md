...
这是 `PIC-tutor` 的 Markdown-first 书稿。当前收束版本是 `v0.27` PSATD time-averaging `Psi/Y` 系数闭环版，目标是先形成一条可复查、可审读、可验证的主线，再逐章加深公式推导、源码逐行讲解、图表和可复现实验。
