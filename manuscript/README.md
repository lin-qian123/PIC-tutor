...
2026-07-13：第 9 章新增文献路线资产合同，12 项检查绑定证据层、核心文献树、literature map、inventory 与 publisher/metadata 缺口；当前公开证据索引为 183 条，合同不替代论文逐式审校或 runtime physics proof。
...
v0.68 新增 `../docs/public-evidence-index.{json,md}`，汇总本地 183 条验证合同的原始状态和边界分类。该摘要去除了本机路径；`runs/` 原始产物仍保持排除，摘要不替代逐项 JSON/Markdown 报告。
