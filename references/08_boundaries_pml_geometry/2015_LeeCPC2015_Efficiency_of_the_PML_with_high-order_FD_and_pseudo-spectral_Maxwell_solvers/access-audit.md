...
3. If the AIP conference bronze OA PDF endpoint becomes accessible, use it as a related version but keep the CPC article as the main WarpX citation.
4. After obtaining a PDF, place it in this directory and run the project paper workflow before updating the manuscript from "access audit" to "paper-reading closure".
