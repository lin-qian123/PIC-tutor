...
def build_report(root: Path) -> dict[str, object]:
    checks = [
        ...
        check(root, "manuscript/VERSION.md", "scripts/verify_v106_build.py"),
        check(root, "docs/public-repo-release-audit.md", f"dist/pic-tutor-{CURRENT_VERSION}.pdf"),
        check(root, "docs/v0.106-release-manifest.json", f'"release": "PIC-tutor {CURRENT_VERSION}"'),
        check(root, "scripts/build_v106.py", f"pic-tutor-{CURRENT_VERSION}"),
        check(root, "scripts/verify_v106_build.py", f"v0.106 artifact verification"),
    ]
