...
def build_report(root: Path) -> dict[str, object]:
    checks = [
        ...
        check(root, "manuscript/VERSION.md", "scripts/verify_v107_build.py"),
        check(root, "docs/public-repo-release-audit.md", f"dist/pic-tutor-{CURRENT_VERSION}.pdf"),
        check(root, "docs/v0.107-release-manifest.json", f'"release": "PIC-tutor {CURRENT_VERSION}"'),
        check(root, "scripts/build_v107.py", f"pic-tutor-{CURRENT_VERSION}"),
        check(root, "scripts/verify_v107_build.py", f"v0.107 artifact verification"),
    ]
