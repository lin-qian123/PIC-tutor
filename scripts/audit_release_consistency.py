...
def build_report(root: Path) -> dict[str, object]:
    checks = [
        ...
        check(root, "manuscript/VERSION.md", "scripts/verify_v98_build.py"),
        check(root, "docs/public-repo-release-audit.md", f"dist/pic-tutor-{CURRENT_VERSION}.pdf"),
        check(root, "docs/v0.98-release-manifest.json", f'"release": "PIC-tutor {CURRENT_VERSION}"'),
        check(root, "scripts/build_v98.py", f"pic-tutor-{CURRENT_VERSION}"),
        check(root, "scripts/verify_v98_build.py", f"v0.98 artifact verification"),
    ]
