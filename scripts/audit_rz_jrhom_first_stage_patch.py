#!/usr/bin/env python
"""Audit whether a WarpX checkout has the RZ JRhom first-stage patch staged."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Report whether a WarpX checkout already has the RZ JRhom first-stage patch staged."
    )
    parser.add_argument(
        "--warpx-root",
        type=Path,
