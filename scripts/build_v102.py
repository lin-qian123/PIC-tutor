#!/usr/bin/env python
"""Build the PIC-tutor v0.102 Markdown, HTML, and optional PDF manuscript."""
...
DIST = ROOT / "dist"
OUTPUT_MD = DIST / "pic-tutor-v0.102.md"
OUTPUT_HTML = DIST / "pic-tutor-v0.102.html"
OUTPUT_PDF = DIST / "pic-tutor-v0.102.pdf"
