#!/usr/bin/env python
"""Build the PIC-tutor v0.34 Markdown manuscript and optional HTML preview."""
...
DIST = ROOT / "dist"
OUTPUT_MD = DIST / "pic-tutor-v0.34.md"
OUTPUT_HTML = DIST / "pic-tutor-v0.34.html"
HTML_STYLE = ROOT / "manuscript" / "assets" / "pic-tutor-html-style.html"

PARTS = [
    ROOT / "manuscript" / "VERSION-v0.34.md",
...
subtitle: "v0.34 comoving PSATD first-stage upstream handoff 版"
author: "PIC-tutor"
date: "2026-06-30"
lang: zh-CN
---
