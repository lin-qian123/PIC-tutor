#!/usr/bin/env python
"""Build the PIC-tutor v0.80 Markdown, HTML, and optional PDF manuscript."""
...
DIST = ROOT / "dist"
OUTPUT_MD = DIST / "pic-tutor-v0.80.md"
OUTPUT_HTML = DIST / "pic-tutor-v0.80.html"
OUTPUT_PDF = DIST / "pic-tutor-v0.80.pdf"
