#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.100 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.100.md", "dist/pic-tutor-v0.100.html", "dist/pic-tutor-v0.100.pdf")
MANIFEST_OUTPUTS = {"docs/v0.100-release-manifest.json", "docs/v0.100-release-manifest.md"}
