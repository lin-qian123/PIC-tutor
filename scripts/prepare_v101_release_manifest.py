#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.101 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.101.md", "dist/pic-tutor-v0.101.html", "dist/pic-tutor-v0.101.pdf")
MANIFEST_OUTPUTS = {"docs/v0.101-release-manifest.json", "docs/v0.101-release-manifest.md"}
