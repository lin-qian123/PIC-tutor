#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.103 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.103.md", "dist/pic-tutor-v0.103.html", "dist/pic-tutor-v0.103.pdf")
MANIFEST_OUTPUTS = {"docs/v0.103-release-manifest.json", "docs/v0.103-release-manifest.md"}
