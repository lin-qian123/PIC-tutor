#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.104 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.104.md", "dist/pic-tutor-v0.104.html", "dist/pic-tutor-v0.104.pdf")
MANIFEST_OUTPUTS = {"docs/v0.104-release-manifest.json", "docs/v0.104-release-manifest.md"}
