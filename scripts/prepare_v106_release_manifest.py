#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.106 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.106.md", "dist/pic-tutor-v0.106.html", "dist/pic-tutor-v0.106.pdf")
MANIFEST_OUTPUTS = {"docs/v0.106-release-manifest.json", "docs/v0.106-release-manifest.md"}
