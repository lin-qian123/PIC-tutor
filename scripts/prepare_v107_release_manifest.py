#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.107 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.107.md", "dist/pic-tutor-v0.107.html", "dist/pic-tutor-v0.107.pdf")
MANIFEST_OUTPUTS = {"docs/v0.107-release-manifest.json", "docs/v0.107-release-manifest.md"}
