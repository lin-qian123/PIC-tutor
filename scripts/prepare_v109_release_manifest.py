#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.109 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.109.md", "dist/pic-tutor-v0.109.html", "dist/pic-tutor-v0.109.pdf")
MANIFEST_OUTPUTS = {"docs/v0.109-release-manifest.json", "docs/v0.109-release-manifest.md"}
