#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.110 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.110.md", "dist/pic-tutor-v0.110.html", "dist/pic-tutor-v0.110.pdf")
MANIFEST_OUTPUTS = {"docs/v0.110-release-manifest.json", "docs/v0.110-release-manifest.md"}
