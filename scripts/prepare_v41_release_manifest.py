#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.41 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.41.md", "dist/pic-tutor-v0.41.html", "dist/pic-tutor-v0.41.pdf")
MANIFEST_OUTPUTS = {"docs/v0.41-release-manifest.json", "docs/v0.41-release-manifest.md"}
...
def main() -> None:
    ...
    for entry in entries:
        if entry["path"].startswith("dist/") or entry["path"] in {"README.md", "TODO.md", "manuscript/VERSION.md", "manuscript/VERSION-v0.40.md"}:
