#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.57 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.57.md", "dist/pic-tutor-v0.57.html", "dist/pic-tutor-v0.57.pdf")
MANIFEST_OUTPUTS = {"docs/v0.57-release-manifest.json", "docs/v0.57-release-manifest.md"}
...
def main() -> None:
    ...
    for entry in entries:
        if entry["path"].startswith("dist/") or entry["path"] in {"README.md", "TODO.md", "manuscript/VERSION.md", "manuscript/VERSION-v0.56.md"}:
