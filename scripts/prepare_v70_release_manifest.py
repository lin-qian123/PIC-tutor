#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.70 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.70.md", "dist/pic-tutor-v0.70.html", "dist/pic-tutor-v0.70.pdf")
MANIFEST_OUTPUTS = {"docs/v0.70-release-manifest.json", "docs/v0.70-release-manifest.md"}
