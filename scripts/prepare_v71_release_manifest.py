#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.71 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.71.md", "dist/pic-tutor-v0.71.html", "dist/pic-tutor-v0.71.pdf")
MANIFEST_OUTPUTS = {"docs/v0.71-release-manifest.json", "docs/v0.71-release-manifest.md"}
