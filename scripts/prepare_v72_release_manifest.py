#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.72 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.72.md", "dist/pic-tutor-v0.72.html", "dist/pic-tutor-v0.72.pdf")
MANIFEST_OUTPUTS = {"docs/v0.72-release-manifest.json", "docs/v0.72-release-manifest.md"}
