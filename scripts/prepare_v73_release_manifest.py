#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.73 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.73.md", "dist/pic-tutor-v0.73.html", "dist/pic-tutor-v0.73.pdf")
MANIFEST_OUTPUTS = {"docs/v0.73-release-manifest.json", "docs/v0.73-release-manifest.md"}
