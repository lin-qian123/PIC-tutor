#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.74 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.74.md", "dist/pic-tutor-v0.74.html", "dist/pic-tutor-v0.74.pdf")
MANIFEST_OUTPUTS = {"docs/v0.74-release-manifest.json", "docs/v0.74-release-manifest.md"}
