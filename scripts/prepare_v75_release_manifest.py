#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.75 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.75.md", "dist/pic-tutor-v0.75.html", "dist/pic-tutor-v0.75.pdf")
MANIFEST_OUTPUTS = {"docs/v0.75-release-manifest.json", "docs/v0.75-release-manifest.md"}
