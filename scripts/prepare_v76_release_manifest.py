#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.76 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.76.md", "dist/pic-tutor-v0.76.html", "dist/pic-tutor-v0.76.pdf")
MANIFEST_OUTPUTS = {"docs/v0.76-release-manifest.json", "docs/v0.76-release-manifest.md"}
