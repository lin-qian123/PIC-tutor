#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.77 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.77.md", "dist/pic-tutor-v0.77.html", "dist/pic-tutor-v0.77.pdf")
MANIFEST_OUTPUTS = {"docs/v0.77-release-manifest.json", "docs/v0.77-release-manifest.md"}
