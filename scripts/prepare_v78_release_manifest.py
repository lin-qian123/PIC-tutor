#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.78 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.78.md", "dist/pic-tutor-v0.78.html", "dist/pic-tutor-v0.78.pdf")
MANIFEST_OUTPUTS = {"docs/v0.78-release-manifest.json", "docs/v0.78-release-manifest.md"}
