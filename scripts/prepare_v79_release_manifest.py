#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.79 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.79.md", "dist/pic-tutor-v0.79.html", "dist/pic-tutor-v0.79.pdf")
MANIFEST_OUTPUTS = {"docs/v0.79-release-manifest.json", "docs/v0.79-release-manifest.md"}
