#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.81 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.81.md", "dist/pic-tutor-v0.81.html", "dist/pic-tutor-v0.81.pdf")
MANIFEST_OUTPUTS = {"docs/v0.81-release-manifest.json", "docs/v0.81-release-manifest.md"}
