#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.82 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.82.md", "dist/pic-tutor-v0.82.html", "dist/pic-tutor-v0.82.pdf")
MANIFEST_OUTPUTS = {"docs/v0.82-release-manifest.json", "docs/v0.82-release-manifest.md"}
