#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.83 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.83.md", "dist/pic-tutor-v0.83.html", "dist/pic-tutor-v0.83.pdf")
MANIFEST_OUTPUTS = {"docs/v0.83-release-manifest.json", "docs/v0.83-release-manifest.md"}
