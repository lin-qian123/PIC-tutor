#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.84 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.84.md", "dist/pic-tutor-v0.84.html", "dist/pic-tutor-v0.84.pdf")
MANIFEST_OUTPUTS = {"docs/v0.84-release-manifest.json", "docs/v0.84-release-manifest.md"}
