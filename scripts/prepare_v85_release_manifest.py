#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.85 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.85.md", "dist/pic-tutor-v0.85.html", "dist/pic-tutor-v0.85.pdf")
MANIFEST_OUTPUTS = {"docs/v0.85-release-manifest.json", "docs/v0.85-release-manifest.md"}
