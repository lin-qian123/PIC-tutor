#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.89 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.89.md", "dist/pic-tutor-v0.89.html", "dist/pic-tutor-v0.89.pdf")
MANIFEST_OUTPUTS = {"docs/v0.89-release-manifest.json", "docs/v0.89-release-manifest.md"}
