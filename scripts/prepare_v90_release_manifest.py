#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.90 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.90.md", "dist/pic-tutor-v0.90.html", "dist/pic-tutor-v0.90.pdf")
MANIFEST_OUTPUTS = {"docs/v0.90-release-manifest.json", "docs/v0.90-release-manifest.md"}
