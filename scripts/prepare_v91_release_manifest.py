#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.91 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.91.md", "dist/pic-tutor-v0.91.html", "dist/pic-tutor-v0.91.pdf")
MANIFEST_OUTPUTS = {"docs/v0.91-release-manifest.json", "docs/v0.91-release-manifest.md"}
