#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.92 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.92.md", "dist/pic-tutor-v0.92.html", "dist/pic-tutor-v0.92.pdf")
MANIFEST_OUTPUTS = {"docs/v0.92-release-manifest.json", "docs/v0.92-release-manifest.md"}
