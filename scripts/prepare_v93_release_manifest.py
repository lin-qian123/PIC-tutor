#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.93 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.93.md", "dist/pic-tutor-v0.93.html", "dist/pic-tutor-v0.93.pdf")
MANIFEST_OUTPUTS = {"docs/v0.93-release-manifest.json", "docs/v0.93-release-manifest.md"}
