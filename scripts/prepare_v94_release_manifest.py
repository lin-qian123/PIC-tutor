#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.94 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.94.md", "dist/pic-tutor-v0.94.html", "dist/pic-tutor-v0.94.pdf")
MANIFEST_OUTPUTS = {"docs/v0.94-release-manifest.json", "docs/v0.94-release-manifest.md"}
