#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.95 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.95.md", "dist/pic-tutor-v0.95.html", "dist/pic-tutor-v0.95.pdf")
MANIFEST_OUTPUTS = {"docs/v0.95-release-manifest.json", "docs/v0.95-release-manifest.md"}
