#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.96 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.96.md", "dist/pic-tutor-v0.96.html", "dist/pic-tutor-v0.96.pdf")
MANIFEST_OUTPUTS = {"docs/v0.96-release-manifest.json", "docs/v0.96-release-manifest.md"}
