#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.97 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.97.md", "dist/pic-tutor-v0.97.html", "dist/pic-tutor-v0.97.pdf")
MANIFEST_OUTPUTS = {"docs/v0.97-release-manifest.json", "docs/v0.97-release-manifest.md"}
