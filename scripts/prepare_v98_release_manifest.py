#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.98 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.98.md", "dist/pic-tutor-v0.98.html", "dist/pic-tutor-v0.98.pdf")
MANIFEST_OUTPUTS = {"docs/v0.98-release-manifest.json", "docs/v0.98-release-manifest.md"}
