#!/usr/bin/env python
"""Create an auditable allowlist for the PIC-tutor v0.99 public release."""
...
RELEASE_DIST = ("dist/pic-tutor-v0.99.md", "dist/pic-tutor-v0.99.html", "dist/pic-tutor-v0.99.pdf")
MANIFEST_OUTPUTS = {"docs/v0.99-release-manifest.json", "docs/v0.99-release-manifest.md"}
