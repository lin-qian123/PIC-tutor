#!/usr/bin/env python
"""Preview the exact diff needed to stage the comoving first-stage patch."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Print a unified diff preview for staging the comoving first-stage patch."
    )
    parser.add_argument(
        "--warpx-root",
        type=Path,
