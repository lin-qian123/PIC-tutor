#!/usr/bin/env python
"""Verify the v0.105 Markdown/HTML/PDF artifact contract after building."""
...
MERGED_MARKDOWN = ROOT / "dist" / "pic-tutor-v0.105.md"
HTML = ROOT / "dist" / "pic-tutor-v0.105.html"
PDF = ROOT / "dist" / "pic-tutor-v0.105.pdf"
MANUAL_SPOTCHECK = ROOT / "docs" / "manual-editorial-spotcheck-v0.105.md"
...
def main() -> None:
    ...
    print("v0.105 artifact verification")
    for name, passed in checks.items():
        print(f"  [{'PASS' if passed else 'FAIL'}] {name}")
    if not all(checks.values()):
        raise SystemExit("v0.105 artifact verification failed")
    print("[PASS] all v0.105 artifact checks")
