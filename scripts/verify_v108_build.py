#!/usr/bin/env python
"""Verify the v0.108 Markdown/HTML/PDF artifact contract after building."""
...
MERGED_MARKDOWN = ROOT / "dist" / "pic-tutor-v0.108.md"
HTML = ROOT / "dist" / "pic-tutor-v0.108.html"
PDF = ROOT / "dist" / "pic-tutor-v0.108.pdf"
MANUAL_SPOTCHECK = ROOT / "docs" / "manual-editorial-spotcheck-v0.108.md"
EXPECTED_PDF_PAGES = 338
...
def main() -> None:
    ...
    print("v0.108 artifact verification")
    for name, passed in checks.items():
        print(f"  [{'PASS' if passed else 'FAIL'}] {name}")
    if not all(checks.values()):
        raise SystemExit("v0.108 artifact verification failed")
    print("[PASS] all v0.108 artifact checks")
